...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    relatedToolSlugs: ["emi-calculator", "gst-calculator", "qr-code-generator"],
  },
  {
    id: "emi-calculator",
    name: "EMI Calculator",
    slug: "emi-calculator",
    description:
      "Calculate monthly loan EMI, total interest, and total repayment.",
    category: "utility",
    categoryLabel: "Utilities",
    iconName: "Calculator",
    status: "active",
    ...
    relatedToolSlugs: ["gst-calculator", "age-calculator", "word-character-counter"],
  },
  {
    id: "gst-calculator",
    name: "GST Calculator",
    slug: "gst-calculator",
    description:
      "Calculate GST amounts, final prices, and CGST/SGST or IGST breakdowns.",
    category: "utility",
    categoryLabel: "Utilities",
    iconName: "Receipt",
    status: "active",
    ...
    relatedToolSlugs: ["emi-calculator", "qr-code-generator", "word-character-counter"],
  },
  {
    id: "text-summarizer",
